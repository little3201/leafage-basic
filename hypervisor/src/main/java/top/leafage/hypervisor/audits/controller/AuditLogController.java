...
import top.leafage.hypervisor.audits.domain.vo.AuditLogVO;
import top.leafage.hypervisor.audits.service.AuditLogService;
...
public class AuditLogController {
     ...
     */
    @PreAuthorize("hasRole('AUDITOR') || hasAuthority('SCOPE_audit_logs')")
    @GetMapping
     ...
     * @param id the pk.
     */
    @PreAuthorize("hasRole('AUDITOR') || hasAuthority('SCOPE_audit_logs:remove')")
    @DeleteMapping("/{id}")
